The following set-up creates a Redshift cluster in a public VPC and allows client to access it directly.  Idea is to allow direct access programmatically or via a tool like DBeaver, pgAdmin, etc.
